...
@app.post("/duplicateCheck/withFile")
async def process_email(email_text: str = Form(...), files: Optional[List[UploadFile]] = File(None), threshold: float = 0.9):
    ...
    return {"email_text": email_text, "duplicates_email": duplicates_email,"duplicates_attachments": duplicates_attachments, "attachments_results": attachment_results}


@app.post("/duplicateCheck/withJsonInput")
